...
Feature: Using EDV REST API
  ...
  @e2e
  Scenario: Full end-to-end flow. Create a data vault, store an encrypted document, and then retrieve the encrypted document.
    ...
    Then  Client stores the Encrypted Document in the data vault with id "testvault" and receives the document location "localhost:8080/encrypted-data-vaults/testvault/docs/VJYHHJx4C8J9Fsgz7rZqSp" in response
